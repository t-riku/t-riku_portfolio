...
const projectsData = [
  ...
  },
  {
    ...
    category: "App",
    time: "2022.12",
    text: `このアプリケーションを制作する前に、"ポケモンSVが発売されて初めてポケモンを本気でやろうと思い、種族値をインターネットで調べ、その時に見てたサイトのデザインがあまり好ましくないなと感じ、自分だったらこういう風なのが良いな"という経緯で制作した「Pokemon app」を作りました。
    しかし制作した後で何か自分の中で納得がいかず、もう一回作り直そうと検討しました。
    デザインはYoutubeにあったものを参考にし、公式のポケモン図鑑な見た目にしました。また機能を複数追加してよりポケモン図鑑に近づけ、そしてNext JSで作り直そうと思いこのアプリケーション制作に至りました。
